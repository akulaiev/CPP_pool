...
{
	std::cout << this->_name << " decided to fight his target." << std::endl;
...
{
	std::cout << this->_name << " decided to challenge his target." << std::endl;
...
void				NinjaTrap::ninjaShoebox(NinjaTrap & ninja)
{
	...
	ninja.beRepaired(30);
	ninja.set_level(5);
	std::cout << "Woo-hoo!!! " << this->_name << "'s level is up!!!" << std::endl;
	std::cout << std::endl;
}

void				NinjaTrap::ninjaShoebox(ClapTrap)
{
	std::cout << this->_name << "'s stats are: " << std::endl;
